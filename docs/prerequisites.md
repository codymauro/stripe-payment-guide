...
- **Success URL** — Payment approved.
	- Example: this page shows something like, “Thanks for your payment!” and optionally retrieves session info to confirm amount or status.
- **Cancel URL** — Payment canceled or abandoned. 
	- This page might say, “Payment canceled. Try again?”
...
**Going live later?** When you publish your site, don’t confirm payments from the `/success` URL page. Use Stripe webhooks.

Webhooks let Stripe automatically notify your backend when a payment succeeds, so your app can safely fulfill orders even if the customer never returns to your site.
